//define([ 'text!pages/test_item/testitem.html',  'print', 'share', 'qrcode'], function( template) {    //xzn
$.get("./src/pages/test_item/testitem.html",function(template){
		        ...
		        u.confirmDialog({
		            ...
		            onOk: function () {
		                $.ajax({
		                	...
		                	type:'post',
		                	data:{data:JSON.stringify(viewModel.mainDataTable.getSimpleData({type:'select',fields:['testitemcode','testitemname']}))},    //xzn
		                	success: function(){
		                		u.showMessage('删除成功！');
