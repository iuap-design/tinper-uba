 ...
 * Date	  : 2016-10-13 20:12:15
 * Update : 2016-10-21 20:12:22
 */
...
module.exports = () => {
    ...
    installWarProcess.on('exit', function(data) {
        ...
        var publishCommandStr = publishConfig.command + " deploy:deploy-file  -Dfile=" + targetPath + " -DgroupId=" + publishConfig.groupId + " -DartifactId=" + publishConfig.artifactId + "  -Dversion=" + publishConfig.version + " -Dpackaging=war  -DrepositoryId=" + publishConfig.repositoryId + " -Durl=" + publishConfig.repositoryURL;
